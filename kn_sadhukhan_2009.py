...
Sadhukhan 2009 kinetic scheme for biomass pyrolysis. Note that this scheme
...
# Function for Sadhukhan 2009 Kinetic Scheme
# ------------------------------------------------------------------------------
...
for i in range(1, nt):
    B[i], VG1[i], C1[i], VG2[i], C2[i] = sadhukhan(B[i-1], VG1[i-1], C1[i-1], VG2[i-1], C2[i-1], T, dt)

# products from primary and secondary reactions
for i in range(1, nt):
    B_2[i], VG1_2[i], C1_2[i], VG2_2[i], C2_2[i] = sadhukhan(B_2[i-1], VG1_2[i-1], C1_2[i-1], VG2_2[i-1], C2_2[i-1], T, dt, s=2)
